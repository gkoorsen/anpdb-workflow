...
archive="${output_dir}/sglt2_mol15088_reps2-3_portable_${stamp}.tar.gz"
...
files=(
  ...
  docs/runpod_sglt2_mol15088_reps2-3.md
  data/md_inputs/anpdb_truly_novel_std.csv
  data/md_inputs/poses/Mol_15088_7VSI_opm_oriented_out.pdbqt
...
for rep in 2 3; do
  ...
  files+=(
    "configs/md/production/sglt2_mol15088_100ns_rep${rep}.toml"
